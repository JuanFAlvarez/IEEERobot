...
def main(ARGS):
    ...
    for frame in frames:
        if frame is not None:
           ...
           #-----------------------------------------------------------------------------------------------
           #logic for robot
            if any(word in text for word in greethi):
                arduinoSerialData.write(b'0')
                print("hello, how areyou?, waving arm")
            elif  any(word in text for word in greetbye):
                print("goodbye human")
                arduinoSerialData.write(b'1')
            elif "robot" in text:
                print("yes I am a robot")
                arduinoSerialData.write(b'2')
            elif any(word in text for word in greethifi):
                print("giving high five!!")
                arduinoSerialData.write(b'5')
            elif any(word in text for word in hearme):
                print("Yes, I can hear you")
            elif any(word in text for word in voiceturn):
